...
-   Deploying [Prometheus Anomaly Detection (PAD)](https://github.com/AICoE/prometheus-anomaly-detector), an existing open-source project 
    developed by the AI team at RedHat to analyze time-series data generated by cloud 
    infrastructure, onto [DataHub](http://opendatahub.io/), a blueprint for building an AI application as a service 
    platform on the [OpenShift Container Platform](https://www.openshift.com/).

-   Understanding and building machine learning models to extend Prometheus Anomaly Detection (PAD).
...
-   Installing OpenShift client datahub on our local development environments to get comfortable with them
...
Ensuring that PAD is deployed onto DataHub with at least one new ML model.
